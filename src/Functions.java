...
public final class Functions
{
    ...
    public static final String CORPSE_KEY = "corpse";
    ...
    */
            ...
            String[] properties, WorldModel world, ImageStore imageStore)
    {
        if (properties.length == SAPLING_NUM_PROPERTIES) {
            ...
            Entity entity = new Sapling( health, SAPLING_HEALTH_LIMIT, SAPLING_ACTION_ANIMATION_PERIOD,SAPLING_ACTION_ANIMATION_PERIOD,id, pt, imageStore.getImageList( SAPLING_KEY));
